...
export function describeFeedStatus(feed: FeedListState): string {
  switch (feed.kind) {
    case "me-profile":
      return feed.hasMore
        ? "个人主页：j/k 浏览  l 打开主题  n/Space 更多主题  Esc/Backspace 返回  h 返回左栏"
        : "个人主页：j/k 浏览  l 打开主题  Esc/Backspace 返回  h 返回左栏";
    case "new":
      return feed.hasMore
    ...
    case "me-favorites":
      return feed.hasMore
        ? "我的收藏：j/k 选择  l 打开帖子  n/Space 更多  Esc/Backspace 返回  h 返回左栏"
        : "我的收藏：j/k 选择  l 打开帖子  Esc/Backspace 返回  h 返回左栏";
    case "me-replies":
      return feed.hasMore
